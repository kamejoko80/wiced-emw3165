...
# Check for valid platform, OSNS combination, build type and bus
...
$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CFLAGS_ALL := $(call ADD_COMPILER_SPECIFIC_STANDARD_CFLAGS,$($(comp)_OPTIM_CFLAGS))) )
$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CFLAGS_ALL += $(EXTRA_CFLAGS)) )
$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CFLAGS_ALL += $($(comp)_CFLAGS)) )

$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CXXFLAGS_ALL := $(call ADD_COMPILER_SPECIFIC_STANDARD_CXXFLAGS,$($(comp)_OPTIM_CXXFLAGS))) )
$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CXXFLAGS_ALL += $(EXTRA_CFLAGS)) )
$(foreach comp,$(PROCESSED_COMPONENTS), $(eval $(call CONV_COMP,$(comp))_CXXFLAGS_ALL += $($(comp)_CXXFLAGS)) )
...
$(CONFIG_FILE): $(WICED_SDK_MAKEFILES) | $(CONFIG_FILE_DIR)
	...
	$(QUIET)$(foreach comp,$(PROCESSED_COMPONENTS), $(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,$(call CONV_COMP,$(comp))_CFLAGS           := $(WICED_SDK_CFLAGS) $($(comp)_CFLAGS_ALL)))
	$(QUIET)$(foreach comp,$(PROCESSED_COMPONENTS), $(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,$(call CONV_COMP,$(comp))_CXXFLAGS         := $(WICED_SDK_CXXFLAGS) $($(comp)_CXXFLAGS_ALL)))
	...
	$(QUIET)$(foreach comp,$(PROCESSED_COMPONENTS), $(call WRITE_FILE_APPEND, $(CONFIG_FILE) ,$(call CONV_COMP,$(comp))_PRE_BUILD_TARGETS:= $($(comp)_PRE_BUILD_TARGETS)))
