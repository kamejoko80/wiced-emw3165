...
OTA_TGT:=$(OTA)-$(PLATFORM_FULL)-$(BUS)
SFLASHWRITER_TGT:=waf.sflash_write-NoOS-NoNS-$(PLATFORM_FULL)-$(BUS)
...
download_sflash: sflash_writer_app
	...
	$(QUIET)$(ECHO_BLANK_LINE)
	$(call CONV_SLASHES,$(OPENOCD_FULL_NAME)) -f $(OPENOCD_PATH)$(JTAG).cfg -f $(OPENOCD_PATH)$(HOST_OPENOCD).cfg -f apps/waf/sflash_write/sflash_write.tcl -c "sflash_write_file $(OUTPUT_DIR)sflash.bin 0x0 $(PLATFORM_FULL)-$(BUS) 1 0" -c shutdown
	$(QUIET)$(ECHO_BLANK_LINE)
