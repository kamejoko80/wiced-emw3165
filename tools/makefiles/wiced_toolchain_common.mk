...
SHOULD_I_WAIT_FOR_DOWNLOAD := $(filter download download_apps, $(MAKECMDGOALS))
CONV_COMP =$(subst /,_,$(1))
BUILD_STRING ?= $(strip $(filter-out $(MAKEFILE_TARGETS) debug download download_apps download_only run terminal no_dct no_tinybl, $(MAKECMDGOALS)))
