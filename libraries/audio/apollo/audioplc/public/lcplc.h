...
/* Prototypes */
void LC_PLC_erasure(struct LCPLC_State  *plc_state, Word16 *out, Word16 *CodecRingBuf,
                    Word16 zirl, Word16 PlcMethod, Word16 CodecConfig);
void LC_PLC(struct LCPLC_State *plc_state, Word16 *in, Word16 *out, Word16 nzsr, Word16 PlcMethod, Word16 CodecConfig);
void Init_LC_PLC(struct LCPLC_State *plc_state, int sf, int frmsz);
void Free_LC_PLC(struct LCPLC_State *plc_state);
