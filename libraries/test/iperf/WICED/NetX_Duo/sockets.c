...
#define TCP_WINDOW_SIZE   (16*1024)
#endif
        ...
        if ( sockets[a].available == WICED_TRUE )
        {
            ...
            switch ( type )
            {
                ...
                case SOCK_STREAM:
                    ...
                    nx_tcp_socket_transmit_configure(&free_socket->socket.tcp, WICED_DEFAULT_TCP_TX_DEPTH_QUEUE, WICED_TCP_SEND_TIMEOUT/WICED_DEFAULT_TCP_TX_RETRIES, WICED_DEFAULT_TCP_TX_RETRIES, 0);
                    break;
            }
