...
NAME := Platform_BCM943909WCD1

# Current board revision. Change this according to your board revision
BOARD_REVISION := 2
...
EXTRA_TARGET_MAKEFILES +=$(SOURCE_ROOT)platforms/BCM943909WCD1/BCM943909WCD1_targets.mk
...
# BCM943909WCD1 rev 2 and prior includes BCM20703 BT chip
BT_CHIP          := 20703
BT_CHIP_REVISION := A1
...
GLOBAL_DEFINES += PLATFORM_A0_AON_MEMORY # Has to be removed for B0
...
#GLOBAL_DEFINES += PLATFORM_BCM943909WCD1
