...
/** @file
 * Defines board support package for BCM943909WCD1 board
 */
#include "stdio.h"
#include "string.h"
#include "platform.h"
...
{
    .patchram_download_mode      = PATCHRAM_DOWNLOAD_MODE_NO_MINIDRV_CMD,
...
{
    [WICED_BT_PIN_RESET]       = &platform_gpio_pins[WICED_GPIO_5],
